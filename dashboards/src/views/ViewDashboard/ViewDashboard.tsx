    ...
    const result = [
      {
        ...
        spec: {
          ...
          source: 'Dashboard',
          sourceDescription:
            'Auto-generated by Logz.io, these variables reflect dashboard metadata like name and time range. Use them in queries, filters, and panel settings.', // LOGZ.IO CHANGE START:: unidash add tooltips to make features more clear to users
          display: {
            name: '__dashboard',
